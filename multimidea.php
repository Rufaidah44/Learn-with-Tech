...
<html lang="ar">
<head>
<title> محاضرة الوسائط المتعددة التفاعلية  </title>
<meta charset="utf-8">
...
<div style="text-align:right"> <img src="images\logo.png" alt="logo" width="300" height="70" class="logores">
  <center>
    <h2 style="margin: 0px;"> محاضرة الوسائط المتعددة التفاعلية</h2>
  <br>
  </center>
</div> 
...
<h3> محاضرة الوسائط المتعددة التفاعلية نظري</h3>

<iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=f1m8v0sak&bgcolor=EEEEEE&t=1542617957" width="640" height="385" seamless="seamless" scrolling="no" frameBorder="0"         allowFullScreen="true"></iframe>



<div style="width:70%;text-align:center;"><br>
    <button class="btn" ><a href="lessons/للوسائط المتعددة التفاعلية .pptx" download="شبكات التواصل عملي .pptx">تحميل PPT</a></button>
    <button class="btn" ><a href="lessons/للوسائط المتعددة التفاعلية .pdf" download="شبكات للوسائط المتعددة التفاعلية .pdf">تحميل PDF</a></button>
</div>

<hr width="70%">

<h3>  محاضرة الوسائط المتعددة التفاعلية عملي</h3>

<iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=fxtp239m7&bgcolor=EEEEEE&t=1542618488" width="640" height="385" seamless="seamless" scrolling="no" frameBorder="0"         allowFullScreen="true"></iframe>


<div style="width:70%;text-align:center;"><br>
    <button class="btn" ><a href="lessons/الوسائط عملي.pptx" download="الوسائط عملي.pptx">تحميل PPT</a></button>
    <button class="btn" ><a href="lessons/الوسائط عملي.pdf" download="الوسائط عملي.pdf">تحميل PDF</a></button>
</div>
<script>
