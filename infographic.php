...
<html lang="ar">
<head>
<title>محاضرة الانفوقرافيك في التعلم  </title>
<meta charset="utf-8">
...
<div style="text-align:right"> <img src="images\logo.png" alt="logo" width="300" height="70" class="logores">
  <center>
    <h2 style="margin: 0px;">محاضرة الانفوقرافيك في التعلم </h2>
  <br>
  </center>
</div> 
...
<h3>محاضرة الانفوقرافيك نظري</h3>
<iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=fvhp239m7&bgcolor=EEEEEE&t=1542617453" width="640" height="385" seamless="seamless" scrolling="no" frameBorder="0"         allowFullScreen="true"></iframe>

<div style="width:70%;text-align:center;"><br>
    <button class="btn" ><a href="lessons/انفوجرافيك نظري .pptx" download="انفوجرافيك نظري .pptx">تحميل PPT</a></button>
    
 <button class="btn" ><a href="lessons/انفوجرافيك نظري .pdf" download="انفوجرافيك نظري .pdf">تحميل PDF</a></button>
</div>
<hr width="70%"><br>

 <h3> محاضرة الانفوقرافيك عملي </h3>

<iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=fdk968i51&bgcolor=EEEEEE&t=1542617695" width="640" height="385" seamless="seamless" scrolling="no" frameBorder="0"         allowFullScreen="true"></iframe>

<div style="width:70%;text-align:center;"><br>
    <button class="btn" ><a href="lessons/انفوجرافيك عملي.pptx" download="انفوجرافيك عملي.pptx">تحميل PPT</a></button>
    <button class="btn" ><a href="lessons/انفوجرافيك عملي.pdf" download="انفوجرافيك عملي.pdf">تحميل PDF</a></button>
</div>
